    ...
    <div>
      {!click ? (
        <div className="flex items-center justify-center h-screen bg-gradient-to-r from-yellow-400 via-red-500 to-pink-500">
          <div className="relative">
            ...
            <div className="p-8 bg-white rounded-lg shadow-lg border-4 border-black mt-12">
              <button
                onClick={() => handleClick()}
                className="px-6 py-3 bg-gradient-to-r from-purple-400 to-blue-500 text-white font-bold text-lg rounded-lg hover:scale-105 transition-transform border-black border-2"
              >
                Click Me
              </button>
            </div>
        ...
        <div className="bg-gradient-to-r from-yellow-400 via-red-500 to-pink-500 min-h-screen text-white App cursor-yorushika">
          {/* Intro Animation */}
          <IntroAnimation />
          <div className="h-screen" style={{ backgroundImage: `url(${g8})`, backgroundSize: 'cover', backgroundAttachment: 'fixed' }}>
            {/* Birthday Message */}
            <BirthdayMessage />
            ...
            <h2 className="font-bold text-black text-center text-5xl mt-8 mb-4">Gallery</h2>
            <Gallery />
          </div>
        </div>
      )}
